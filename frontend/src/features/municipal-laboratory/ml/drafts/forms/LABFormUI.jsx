...
function useLabForm(onSuccess) {
  ...
  const usuarios_atendidos = useWatch({ control: form.control, name: "usuarios_atendidos" });
  const exames_realizados = useWatch({ control: form.control, name: "exames_realizados" });
  const hemogramas = useWatch({ control: form.control, name: "hemogramas" });
  const culturas_baar = useWatch({ control: form.control, name: "culturas_baar" });
  const procedimentos_baciloscopia_turberculose = useWatch({ control: form.control, name: "procedimentos_baciloscopia_turberculose" });
  const exames_baciloscopia_hanseniase = useWatch({ control: form.control, name: "exames_baciloscopia_hanseniase" });
  const exames_vdrl_realizados_em_gestantes = useWatch({ control: form.control, name: "exames_vdrl_realizados_em_gestantes" });
  const exames_parasitológico_fezes = useWatch({ control: form.control, name: "exames_parasitológico_fezes" });
  const exames_confirmatorios_HIV = useWatch({ control: form.control, name: "exames_confirmatorios_HIV" });
  ...
  const hbs_ag_rapido = useWatch({ control: form.control, name: "hbs_ag_rapido" });
  const exames_vdri_realizados_populacao_geral = useWatch({ control: form.control, name: "exames_vdri_realizados_populacao_geral" });
  const exames_ppd_prova_tuberculínica = useWatch({ control: form.control, name: "exames_ppd_prova_tuberculínica" });
  const exames_hcg_quantitativo = useWatch({ control: form.control, name: "exames_hcg_quantitativo" });
  const coletas_domiciliares = useWatch({ control: form.control, name: "coletas_domiciliares" });
  const coleta_exame_pcr_covid_19 = useWatch({ control: form.control, name: "coleta_exame_pcr_covid_19" });
  const coleta_exame_pcr_para_dengue = useWatch({ control: form.control, name: "coleta_exame_pcr_para_dengue" });
