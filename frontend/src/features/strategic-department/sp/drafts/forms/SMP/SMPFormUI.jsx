  ...
  return (
    <form onSubmit={handleSubmit} noValidate>
      <div className="border border-gray-300 rounded-md p-8 bg-white shadow-sm space-y-8">
        ...
        <div className="mt-6">
          <div>
            <h2 className="text-2xl font-semibold">Selecionar Unidade, Mês e Ano</h2>
          </div>
          <div className="grid grid-cols-3 sm:grid-cols-3 lg:grid-cols-3 gap-6 mt-6">
            <FormField
        ...
        <div className="mt-14">
          <h2 className="text-2xl font-semibold text-gray-800">
            Cadastros e Movimentações Mensais
          </h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
            <FormField
      ...
      <section className="px-10 py-8">
        <div className="border-b border-gray-300 pb-4">
          <h1 className="text-3xl font-bold text-black">
            Formulário de Materiais Especiais
          </h1>
